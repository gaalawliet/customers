			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zcustomers-display": {
								"semanticObject": "zcustomers",
								"action": "display",
								"description": "Aplicativo de cadastro de clientes",
								"title": "Cadastro de clientes",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zcustomers",
									"url": sap.ui.require.toUrl("zcustomers")
								}
							}
						}
					}
